...
from filesystem_supertool2.solidlsp._compat import mark_used
from filesystem_supertool2.solidlsp.lsp_protocol_handler.lsp_types import DiagnosticSeverity, SymbolKind
