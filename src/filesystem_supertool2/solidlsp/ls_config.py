...
if TYPE_CHECKING:
    from filesystem_supertool2.solidlsp import SolidLanguageServer
...
class LanguageServerId(str, Enum):
    ...
    def get_ls_class(self) -> type["SolidLanguageServer"]:
        match self:
            case self.PYTHON:
                from filesystem_supertool2.solidlsp.language_servers.pyright_server import PyrightServer

                return PyrightServer
            case self.PYTHON_JEDI:
                from filesystem_supertool2.solidlsp.language_servers.jedi_server import JediServer

                return JediServer
            case self.PYTHON_TY:
                from filesystem_supertool2.solidlsp.language_servers.ty_server import TyLanguageServer

                return TyLanguageServer
            case self.PYTHON_PYREFLY:
                from filesystem_supertool2.solidlsp.language_servers.pyrefly_server import PyreflyLanguageServer

                return PyreflyLanguageServer
            case self.PYTHON_BASEDPYRIGHT:
                from filesystem_supertool2.solidlsp.language_servers.basedpyright_server import BasedPyrightLanguageServer

                return BasedPyrightLanguageServer
            case self.JAVA:
                from filesystem_supertool2.solidlsp.language_servers.eclipse_jdtls import EclipseJDTLS

                return EclipseJDTLS
            case self.KOTLIN:
                from filesystem_supertool2.solidlsp.language_servers.kotlin_language_server import KotlinLanguageServer

                return KotlinLanguageServer
            case self.RUST:
                from filesystem_supertool2.solidlsp.language_servers.rust_analyzer import RustAnalyzer

                return RustAnalyzer
            case self.CSHARP:
                from filesystem_supertool2.solidlsp.language_servers.csharp_language_server import CSharpLanguageServer

                return CSharpLanguageServer
            case self.CSHARP_OMNISHARP:
                from filesystem_supertool2.solidlsp.language_servers.omnisharp import OmniSharp

                return OmniSharp
            case self.TYPESCRIPT:
                from filesystem_supertool2.solidlsp.language_servers.typescript_language_server import TypeScriptLanguageServer

                return TypeScriptLanguageServer
            case self.TYPESCRIPT_VTS:
                from filesystem_supertool2.solidlsp.language_servers.vts_language_server import VtsLanguageServer

                return VtsLanguageServer
            case self.VUE:
                from filesystem_supertool2.solidlsp.language_servers.vue_language_server import VueLanguageServer

                return VueLanguageServer
            case self.SVELTE:
                from filesystem_supertool2.solidlsp.language_servers.svelte_language_server import SvelteLanguageServer

                return SvelteLanguageServer
            case self.GO:
                from filesystem_supertool2.solidlsp.language_servers.gopls import Gopls

                return Gopls
            case self.RUBY:
                from filesystem_supertool2.solidlsp.language_servers.ruby_lsp import RubyLsp

                return RubyLsp
            case self.RUBY_SOLARGRAPH:
                from filesystem_supertool2.solidlsp.language_servers.solargraph import Solargraph

                return Solargraph
            case self.DART:
                from filesystem_supertool2.solidlsp.language_servers.dart_language_server import DartLanguageServer

                return DartLanguageServer
            case self.CPP:
                from filesystem_supertool2.solidlsp.language_servers.clangd_language_server import ClangdLanguageServer

                return ClangdLanguageServer
            case self.CPP_CCLS:
                from filesystem_supertool2.solidlsp.language_servers.ccls_language_server import CCLS

                return CCLS
            case self.PHP:
                from filesystem_supertool2.solidlsp.language_servers.intelephense import Intelephense

                return Intelephense
            case self.PHP_PHPACTOR:
                from filesystem_supertool2.solidlsp.language_servers.phpactor import PhpactorServer

                return PhpactorServer
            case self.PHP_PHPANTOM:
                from filesystem_supertool2.solidlsp.language_servers.phpantom import PHPantomServer

                return PHPantomServer
            case self.PERL:
                from filesystem_supertool2.solidlsp.language_servers.perl_language_server import PerlLanguageServer

                return PerlLanguageServer
            case self.CLOJURE:
                from filesystem_supertool2.solidlsp.language_servers.clojure_lsp import ClojureLSP

                return ClojureLSP
            case self.ELIXIR:
                from filesystem_supertool2.solidlsp.language_servers.elixir_tools.elixir_tools import ElixirTools

                return ElixirTools
            case self.ELM:
                from filesystem_supertool2.solidlsp.language_servers.elm_language_server import ElmLanguageServer

                return ElmLanguageServer
            case self.TERRAFORM:
                from filesystem_supertool2.solidlsp.language_servers.terraform_ls import TerraformLS

                return TerraformLS
            case self.SWIFT:
                from filesystem_supertool2.solidlsp.language_servers.sourcekit_lsp import SourceKitLSP

                return SourceKitLSP
            case self.BASH:
                from filesystem_supertool2.solidlsp.language_servers.bash_language_server import BashLanguageServer

                return BashLanguageServer
            case self.CRYSTAL:
                from filesystem_supertool2.solidlsp.language_servers.crystal_language_server import CrystalLanguageServer

                return CrystalLanguageServer
            case self.CUE:
                from filesystem_supertool2.solidlsp.language_servers.cue_language_server import CueLanguageServer

                return CueLanguageServer
            case self.YAML:
                from filesystem_supertool2.solidlsp.language_servers.yaml_language_server import YamlLanguageServer

                return YamlLanguageServer
            case self.JSON:
                from filesystem_supertool2.solidlsp.language_servers.json_language_server import JsonLanguageServer

                return JsonLanguageServer
            case self.TOML:
                from filesystem_supertool2.solidlsp.language_servers.taplo_server import TaploServer

                return TaploServer
            case self.ZIG:
                from filesystem_supertool2.solidlsp.language_servers.zls import ZigLanguageServer

                return ZigLanguageServer
            case self.NIX:
                from filesystem_supertool2.solidlsp.language_servers.nixd_ls import NixLanguageServer

                return NixLanguageServer
            case self.LUA:
                from filesystem_supertool2.solidlsp.language_servers.lua_ls import LuaLanguageServer

                return LuaLanguageServer

            case self.LUAU:
                from filesystem_supertool2.solidlsp.language_servers.luau_lsp import LuauLanguageServer

                return LuauLanguageServer

            case self.ERLANG:
                from filesystem_supertool2.solidlsp.language_servers.erlang_language_server import ErlangLanguageServer

                return ErlangLanguageServer
            case self.OCAML:
                from filesystem_supertool2.solidlsp.language_servers.ocaml_lsp_server import OcamlLanguageServer

                return OcamlLanguageServer
            case self.AL:
                from filesystem_supertool2.solidlsp.language_servers.al_language_server import ALLanguageServer

                return ALLanguageServer
            case self.REGO:
                from filesystem_supertool2.solidlsp.language_servers.regal_server import RegalLanguageServer

                return RegalLanguageServer
            case self.MARKDOWN:
                from filesystem_supertool2.solidlsp.language_servers.marksman import Marksman

                return Marksman
            case self.LATEX:
                from filesystem_supertool2.solidlsp.language_servers.texlab_language_server import TexlabLanguageServer

                return TexlabLanguageServer
            case self.R:
                from filesystem_supertool2.solidlsp.language_servers.r_language_server import RLanguageServer

                return RLanguageServer
            case self.SCALA:
                from filesystem_supertool2.solidlsp.language_servers.scala_language_server import ScalaLanguageServer

                return ScalaLanguageServer
            case self.JULIA:
                from filesystem_supertool2.solidlsp.language_servers.julia_server import JuliaLanguageServer

                return JuliaLanguageServer
            case self.FORTRAN:
                from filesystem_supertool2.solidlsp.language_servers.fortran_language_server import FortranLanguageServer

                return FortranLanguageServer
            case self.HASKELL:
                from filesystem_supertool2.solidlsp.language_servers.haskell_language_server import HaskellLanguageServer

                return HaskellLanguageServer
            case self.HAXE:
                from filesystem_supertool2.solidlsp.language_servers.haxe_language_server import HaxeLanguageServer

                return HaxeLanguageServer
            case self.LEAN4:
                from filesystem_supertool2.solidlsp.language_servers.lean4_language_server import Lean4LanguageServer

                return Lean4LanguageServer
            case self.FSHARP:
                from filesystem_supertool2.solidlsp.language_servers.fsharp_language_server import FSharpLanguageServer

                return FSharpLanguageServer
            case self.POWERSHELL:
                from filesystem_supertool2.solidlsp.language_servers.powershell_language_server import PowerShellLanguageServer

                return PowerShellLanguageServer
            case self.PASCAL:
                from filesystem_supertool2.solidlsp.language_servers.pascal_server import PascalLanguageServer

                return PascalLanguageServer
            case self.GROOVY:
                from filesystem_supertool2.solidlsp.language_servers.groovy_language_server import GroovyLanguageServer

                return GroovyLanguageServer
            case self.MATLAB:
                from filesystem_supertool2.solidlsp.language_servers.matlab_language_server import MatlabLanguageServer

                return MatlabLanguageServer
            case self.HLSL:
                from filesystem_supertool2.solidlsp.language_servers.hlsl_language_server import HlslLanguageServer

                return HlslLanguageServer
            case self.SYSTEMVERILOG:
                from filesystem_supertool2.solidlsp.language_servers.systemverilog_server import SystemVerilogLanguageServer

                return SystemVerilogLanguageServer
            case self.SOLIDITY:
                from filesystem_supertool2.solidlsp.language_servers.solidity_language_server import SolidityLanguageServer

                return SolidityLanguageServer
            case self.ANSIBLE:
                from filesystem_supertool2.solidlsp.language_servers.ansible_language_server import AnsibleLanguageServer

                return AnsibleLanguageServer
            case self.MSL:
                from filesystem_supertool2.solidlsp.language_servers.msl_language_server import MslLanguageServer

                return MslLanguageServer
            case self.BSL:
                from filesystem_supertool2.solidlsp.language_servers.bsl_language_server import BSLLanguageServer

                return BSLLanguageServer
            case self.ADA:
                from filesystem_supertool2.solidlsp.language_servers.ada_language_server import AdaLanguageServer

                return AdaLanguageServer
            case self.GDSCRIPT:
                from filesystem_supertool2.solidlsp.language_servers.godot_language_server import GodotLanguageServer

                return GodotLanguageServer
            case self.QML:
                from filesystem_supertool2.solidlsp.language_servers.qml_language_server import QmlLanguageServer

                return QmlLanguageServer
            case self.HTML:
                from filesystem_supertool2.solidlsp.language_servers.vscode_html_language_server import VsCodeHtmlLanguageServer

                return VsCodeHtmlLanguageServer
            case self.SCSS:
                from filesystem_supertool2.solidlsp.language_servers.some_sass_language_server import SomeSassLanguageServer

                return SomeSassLanguageServer
            case self.ANGULAR:
                from filesystem_supertool2.solidlsp.language_servers.angular_language_server import AngularLanguageServer
